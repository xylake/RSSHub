...
router.get('/nature/subject/:subject/:journal?', lazyloadRouteHandler('./routes/nature/subject'));
...
// hao6v.com
router.get('/hao6v/new', lazyloadRouteHandler('./routes/hao6v/zx'));

//researchgate
router.get('/researchgate/:type?/:param?', lazyloadRouteHandler('./routes/researchgate/author'));
